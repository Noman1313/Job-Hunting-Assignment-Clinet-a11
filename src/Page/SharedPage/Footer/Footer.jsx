        ...
        <div>
            <footer className="footer p-10 bg-base-200  rounded-t-md">
                <aside className='mt-10'>
                    ...
                    <p className='text-xl font-semibold'>Job Hunter</p>
                </aside>
                <nav>
                    ...
                    <a className="link link-hover">Office address</a>
                </nav>
                <nav className='mt-10'>
            ...
            <footer className="footer pb-7 bg-base-200 flex justify-center">
                <p>Copyright © 2023 - All right reserved by job hunter</p>
            </footer>
        </div>
    );
};
